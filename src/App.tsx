      ...
      <main className="max-w-screen-xl mx-auto w-full flex-grow px-4">
        ...
        <ScrollReveal><section className="mb-32">
          <div className="bg-[#023859] rounded-[3rem] p-12 md:p-20 text-white relative overflow-hidden shadow-2xl border border-[#D4AF37]/20">
            ...
            <div className="relative z-10 grid md:grid-cols-3 gap-8">
              ...
              <ScrollReveal delay={150} className="h-full"><div className="bg-[#011C40]/50 backdrop-blur-md p-8 rounded-[2rem] border border-[#26658C]/50 hover:bg-[#26658C]/40 transition-colors h-full flex flex-col"><h3 className="text-xl md:text-2xl font-bold mb-3 text-[#D4AF37] font-heading">AI Notifications</h3><p className="text-[#A7EBF2]/80 text-sm leading-relaxed">Proactive alerts for milestones, delays, and compliance issues.</p></div></ScrollReveal>
              <ScrollReveal delay={300} className="h-full"><div className="bg-[#011C40]/50 backdrop-blur-md p-8 rounded-[2rem] border border-[#26658C]/50 hover:bg-[#26658C]/40 transition-colors h-full flex flex-col"><h3 className="text-xl md:text-2xl font-bold mb-3 text-[#D4AF37] font-heading">Automated Workflows</h3><p className="text-[#A7EBF2]/80 text-sm leading-relaxed">Faster booking, documentation, and customs clearance.</p></div></ScrollReveal>
              <ScrollReveal delay={450} className="h-full md:col-span-1"><div className="bg-[#011C40]/50 backdrop-blur-md p-8 rounded-[2rem] border border-[#26658C]/50 hover:bg-[#26658C]/40 transition-colors h-full flex flex-col"><h3 className="text-xl md:text-2xl font-bold mb-3 text-[#D4AF37] font-heading">Secure Document Management</h3><p className="text-[#A7EBF2]/80 text-sm leading-relaxed">Digital bills of lading, invoices, and certificates with role-based access controls.</p></div></ScrollReveal>
              <ScrollReveal delay={600} className="h-full md:col-span-2"><div className="bg-[#011C40]/50 backdrop-blur-md p-8 rounded-[2rem] border border-[#26658C]/50 hover:bg-[#26658C]/40 transition-colors h-full flex flex-col"><h3 className="text-xl md:text-2xl font-bold mb-3 text-[#D4AF37] font-heading">Mobile & Web Access</h3><p className="text-[#A7EBF2]/80 text-sm leading-relaxed">Easy access to shipment data and reporting on desktop and mobile devices.</p></div></ScrollReveal>
            </div>
          </div>
        </section></ScrollReveal>
        ...
        <ScrollReveal><section className="mb-32 text-center">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-6">
            ...
            <div className="bg-[#023859]/80 backdrop-blur-md rounded-[2rem] overflow-hidden shadow-2xl border border-[#26658C]/50 hover:border-[#D4AF37] hover:-translate-y-2 transition-all flex flex-col group"><div className="h-40 w-full overflow-hidden bg-[#011C40]"><img src="/pharma.jpg" alt="Pharmaceuticals & Healthcare" className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-700 opacity-70" /></div><div className="p-8 flex flex-col items-center"><svg className="w-10 h-10 text-[#D4AF37] mb-4" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24"><path d="M21 16V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16z" /><circle cx="12" cy="12" r="4" /></svg><h4 className="font-bold text-white text-lg text-center">Pharmaceuticals & Healthcare</h4></div></div>
            <div className="bg-[#023859]/80 backdrop-blur-md rounded-[2rem] overflow-hidden shadow-2xl border border-[#26658C]/50 hover:border-[#D4AF37] hover:-translate-y-2 transition-all flex flex-col group"><div className="h-40 w-full overflow-hidden bg-[#011C40]"><img src="/automotive.jpg" alt="Automotive & Engineering" className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-700 opacity-70" /></div><div className="p-8 flex flex-col items-center"><svg className="w-10 h-10 text-[#D4AF37] mb-4" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z" /><polyline points="14 2 14 8 20 8" /><line x1="16" y1="13" x2="8" y2="13" /><line x1="16" y1="17" x2="8" y2="17" /><polyline points="10 9 9 9 8 9" /></svg><h4 className="font-bold text-white text-lg text-center">Automotive & Engineering</h4></div></div>
