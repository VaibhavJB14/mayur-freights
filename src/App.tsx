    ...
    <main className="max-w-screen-xl mx-auto w-full flex-grow px-4 py-24">
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
        {[
          ...
          { title: 'End-to-End Logistics Solutions', desc: 'Integrated supply chain management, multimodal transportation planning, vendor coordination, and reverse logistics to reduce lead times and lower total landed cost.', img: '/end-to-end-logistics.jpg', icon: <><path d="M21 16V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16z"/><circle cx="12" cy="12" r="4"/></> },
